...
for d = 1    
    ...
    Xin.D.Sys.Configurations = [Xin.D.Sys.Configurations; table(...
        {'Pointgrey_16307994_PA5:ON'},...
        {'PointGrey'},  {'16307994'},   {1},...
        'VariableNames',            SysConfigVarName)];
    Xin.D.Sys.Configurations = [Xin.D.Sys.Configurations; table(...
        {'Pointgrey_17475746_Freiwald_PA5:OFF'},...
        {'PointGrey'},  {'17475746'},   {0},...
        'VariableNames',            SysConfigVarName)];
    Xin.D.Sys.Configurations = [Xin.D.Sys.Configurations; table(...
        {'Pointgrey_17475746_Freiwald_PA5:ON'},...
        {'PointGrey'},  {'17475746'},   {1},...
        'VariableNames',            SysConfigVarName)];
    Xin.D.Sys.Configurations = [Xin.D.Sys.Configurations; table(...
        {'Thorlabs_06019_PA5:OFF'},...
        {'Thorlabs'},   {'06019'},      {0},...
        'VariableNames',            SysConfigVarName)];  
    Xin.D.Sys.Configurations = [Xin.D.Sys.Configurations; table(...
        {'Thorlabs_06019_PA5:ON'},...
        {'Thorlabs'},   {'06019'},      {1},...
        'VariableNames',            SysConfigVarName)];   
    Xin.D.Sys.Configurations = [Xin.D.Sys.Configurations; table(...
        {'Thorlabs_08337_PA5:OFF'},...
        {'Thorlabs'},   {'08337'},      {0},...
        'VariableNames',            SysConfigVarName)];  
    Xin.D.Sys.Configurations = [Xin.D.Sys.Configurations; table(...
        {'Thorlabs_08337_PA5:ON'},...
        {'Thorlabs'},   {'08337'},      {1},...
        'VariableNames',            SysConfigVarName)];          
...
%         'TimebaseBridgeLine',     	'20MHzTimebase');
    ...
    Xin.D.Sys.NIDAQ.Config = struct(...
        ...
        'AO_chanIDs',               0,...                       % Sound Output
        'DO_Juice_chanIDs',         2,...                       % Juice trigger
...
%         'AI_chanIDs',               0,...                       % Power Meter Input
%         'AI_rate',                  100e3,...                   % AI sampling rate
%         'AO_chanIDs',               'ao0',...                   % Sound Output
%         'AO_Juice_chanIDs',         'port0/line8',...           % Juice trigger
%         'CO_Frame_chanIDs',         'port0/line31',...          % Frame Trigger
%         'CO_Monitor_chanIDs',       2,...                       % Monitor Trigger
%         'CO_Start_chanIDs',         0,...                       % Start Trigger
%         'DevStartSourceLine',       'RTSI6',...                 % Dev Start Trigger Source
%         'DevTimebaseSourceLine',	'20MHzTimebase',...         % Dev Timbebase Source
